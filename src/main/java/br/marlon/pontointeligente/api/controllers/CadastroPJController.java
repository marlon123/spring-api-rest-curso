package br.marlon.pontointeligente.api.controllers;
...
import br.marlon.pontointeligente.api.dtos.CadastroPJDto;
import br.marlon.pontointeligente.api.entities.Empresa;
import br.marlon.pontointeligente.api.entities.Funcionario;
import br.marlon.pontointeligente.api.enums.PerfilEnum;
import br.marlon.pontointeligente.api.response.Response;
import br.marlon.pontointeligente.api.services.EmpresaService;
...
@RestController//informando que é um endponit
@RequestMapping("/api/cadastrar-pj")//mapeamento
@CrossOrigin(origins = "*")//permitindo acesso de aplicações que estão em domínios distintos
